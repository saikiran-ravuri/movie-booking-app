      ...
      {upcomingDates.map((item) => {
        ...
        return (
          <button
            ...
            className={`flex flex-col items-center justify-center min-w-[72px] sm:min-w-[76px] px-3 py-2 rounded-2xl border transition-all cursor-pointer whitespace-nowrap shrink-0 shadow-2xs ${isSelected

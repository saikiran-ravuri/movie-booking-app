        ...
        <div className="flex flex-wrap items-center gap-3">
          {sortedShows.map((show) => (
            <Link
              ...
              className="px-4 py-2.5 rounded-xl border border-slate-200/90 bg-slate-50 hover:bg-slate-950 hover:text-white hover:border-slate-950 text-slate-900 text-xs font-bold tracking-tight transition-all cursor-pointer shadow-2xs hover:shadow-md inline-block"
            >
              {show.showTime}
            </Link>
          ))}
